 ...
 */
public final class FloatApproximatelyEqual extends TwoFloat implements EqualityComparison {
  ...
  @Prototype FloatApproximatelyEqual() {
    super();
  }

  private static @Prototype FloatApproximatelyEqual proto = new @Prototype FloatApproximatelyEqual();
  /** Returns the prototype invariant for FloatApproximatelyEqual. */
  public static @Prototype FloatApproximatelyEqual get_proto() {
    return proto;
  }
  ...
  /** Returns true if the specified var types are valid for FloatApproximatelyEqual. */
  @Override
  ...
  // Look up a previously instantiated FloatApproximatelyEqual relationship.
  // Should this implementation be made more efficient?
  public static @Nullable FloatApproximatelyEqual find(PptSlice ppt) {
    assert ppt.arity() == 2;
    for (Invariant inv : ppt.invs) {
      if (inv instanceof FloatApproximatelyEqual) {
        return (FloatApproximatelyEqual) inv;
      }
    }

    // If the invariant is suppressed, create it
    if ((suppressions != null) && suppressions.suppressed(ppt)) {
      FloatApproximatelyEqual inv = proto.instantiate_dyn(ppt);
  ...
  @Override
  public String repr(@GuardSatisfied FloatApproximatelyEqual this) {
    return "FloatApproximatelyEqual" + varNames();
  }

  @SideEffectFree
  @Override
  public String format_using(@GuardSatisfied FloatApproximatelyEqual this, OutputFormat format) {
    ...
    if (format.isJavaFamily()) {
        ...
        return Invariant.formatFuzzy("approx_eq", var1(), var2(), format);

    }

    if (format == OutputFormat.SIMPLIFY) {

        String comparator = "APPROX_EQ";
